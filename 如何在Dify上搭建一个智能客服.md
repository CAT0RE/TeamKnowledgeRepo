...
![添加问题分类器节点](./images/iShot_2025-05-21_11.44.49.png)

Step 2. 设置分类器的类别

![设置分类器类别](./images/iShot_2025-05-21_09.59.29.png)

Step 3. 配置分类器的提示词

![配置分类器提示词](./images/iShot_2025-05-21_10.02.13.png)
...
![添加直接回复节点](./images/iShot_2025-05-21_10.05.06.png)

Step 2. 在直接回复的节点中，添加上需要直接回复的内容：

![设置直接回复内容](./images/iShot_2025-05-21_10.05.39.png)
...
![添加LLM节点](./images/iShot_2025-05-21_10.10.10.png)

`LLM`就是Large Language Model，其作用就是调用大语言模型对问题进行回答。
![配置LLM节点](./images/iShot_2025-05-21_10.14.26.png)
